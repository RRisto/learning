...
src_data = torch.randint(4, src_vocab_size, (64, max_seq_length))  # (batch_size, seq_length)
tgt_data = torch.randint(4, tgt_vocab_size, (64, max_seq_length))  # (batch_size, seq_length)
